...
txt_scrolling
	DEFB "             "
	DEFB " GESCHICHTE UND PROGRAMMIERUNG: ORIENS"
	DB &FE
	DEFB "         GRAFIK: CED       "
	DB &FE
	DEFB "  MUSIK: TOM AND JERRY  "
	DB &FE
	DEFB "     INTRO: KUKULCAN     "
	DB &FE
	DEFB "        LOGO: FRA        "
	DB &FE
	DEFB " GFX TITEL: Y. KLAPSAKIS "
	DB &FE
...
aff_presents
	...
	LD HL,txt_presents
	LD DE,&C51D-3 ;affichage
	CALL directmini
	;petit trait au dessus du A
	LD A,&AA
	LD (&F4D0),A
	LD (&F4D1),A
	RET
