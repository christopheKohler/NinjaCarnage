...
txt_press_space
	...
	;DEFB "PREMERE SPAZIO PER INIZIARE"
	 DEFB "PULSA ESPACIO PARA EMPEZAR"
	DB 0
...
txt_now_loading1
	...
	DB 0
txt_now_loading2
	 DEFB "    ESPERA POR FAVOR"
	DB 0

txt_scrolling
	DEFB "             "
	DEFB " HISTORIA Y CODIGO : ORIENS"
	DB &FE
	DEFB "          ARTE : CED         "
	DB &FE
	DEFB "  MUSICA : TOM AND JERRY  "
	DB &FE
	DEFB "     INTRO : KUKULCAN     "
	DB &FE
	DEFB "        LOGO : FRA        "
	DB &FE
	DEFB " PANTALLA DE CARGA : Y. KLAPSAKIS"
	DB &FE
